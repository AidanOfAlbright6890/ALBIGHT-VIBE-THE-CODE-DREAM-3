...
oCustomer1Animation = Character(window, 'customer.png', (22, 140), customer1AnimTuple, .1)
...
employee2AnimTuple = ('Employee 2.png', 'Employee 3.png')

oEmployee1Animation = Character(window, 'Employee 2.png', (332, 140), employee1AnimTuple, .1)

oEmployee2Animation = Character(window, 'Employee 2.png', (550, 140), employee1AnimTuple, .1)
...
oplaybutton4 = pygwidgets.TextButton(window, (620, 120), "Play4")
