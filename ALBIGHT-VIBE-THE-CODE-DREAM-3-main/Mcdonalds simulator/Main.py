...
obackroundimage = pygwidgets.Image(window, (0,0), 'Mcdonalds simulator/5c88fc01b1c7dcad608ac839a67968fc.jpg')
oscreen = pygwidgets.Image(window, (0, 0), 'Mcdonalds simulator/Custom Mcdonalds jpg 5.jpg')
...
class Customscreen():
    def __init__(self, window, WINDOW_WIDTH, WINDOW_HEIGHT):
        ...
        self.customscreen = pygame.image.load('Mcdonalds simulator/5c88fc01b1c7dcad608ac839a67968fc.jpg')
