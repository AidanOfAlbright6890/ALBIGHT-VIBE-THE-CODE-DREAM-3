...
obackroundimage = pygwidgets.Image(window, (0,0), 'ALBIGHT-VIBE-THE-CODE-DREAM-3-main/ALBIGHT-VIBE-THE-CODE-DREAM-3-main/Mcdonalds simulator/5c88fc01b1c7dcad608ac839a67968fc.jpg')
oscreen = pygwidgets.Image(window, (0, 0), 'ALBIGHT-VIBE-THE-CODE-DREAM-3-main/ALBIGHT-VIBE-THE-CODE-DREAM-3-main/Mcdonalds simulator/Custom Mcdonalds jpg 5.jpg')
...
class Customscreen():
    def __init__(self, window, WINDOW_WIDTH, WINDOW_HEIGHT):
        ...
        self.customscreen = pygame.image.load('ALBIGHT-VIBE-THE-CODE-DREAM-3-main/ALBIGHT-VIBE-THE-CODE-DREAM-3-main/Mcdonalds simulator/Custom Mcdonalds jpg 5.jpg')
